...
o = s:option(ListValue, "lazy", translate("Lazy Mode"))
o.description = translate("When Enabled, The Group Only Tests Delay When Used; Disable To Actively Probe Delay On Boot And Periodically By Interval (Recommended For Auto Selecting Best Node)")
o:value("false", translate("Disable(Actively Probe)"))
o:value("true", translate("Enable(Lazy)"))
o.default = "false"
o.rmempty = true
o:depends("type", "url-test")
o:depends("type", "fallback")
